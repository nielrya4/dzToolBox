...
new MultiSelect(document.getElementById('unmix_outputs_select'), {
    data: [
        {
            value: 'trials_graph',
            text: 'Top Trials Graph',
            selected: true
        },
        {
            value: 'contribution_graph',
            text: 'Relative Contribution Graph',
            selected: true
        },
        {
            value: 'contribution_table',
            text: 'Relative Contribution Table',
            selected: true
        }
    ],
    search: false,
